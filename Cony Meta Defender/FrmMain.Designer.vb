...
Partial Class FrmMain
    ...
    Private Sub InitializeComponent()
        ...
        Me.LVArquivos = New ConiglioMetadefender.STListView()
        Me.LVResult = New ConiglioMetadefender.STListView()
        ...
        'CHENGINE
        '
        CHENGINE.Text = "Antivirus"
        CHENGINE.Width = 207
        '
        'CHRESULT
        '
        CHRESULT.Text = "Risultato"
        CHRESULT.Width = 198
        '
        'GList
        '
